...
distributionrules_magro <- validate::validator(
  DF_M_AGRO_out_year = validate::do_by(M_AGRO, by = ANO, fun = hampel_filter) == FALSE, # Comparação por ano
  DF_M_AGRO_out_city = validate::do_by(M_AGRO, by = IBGE7, fun = hampel_filter) == FALSE, # Comparação por município
...
distributionrules_mbovino <- validate::validator(
  ...
  DF_M_BOVINO = M_BOVINO <= (konst*validate::do_by(M_BOVINO, by = ANO, fun = zoo::rollmedian, k = 3, fill = NA, align = "right"))
)
...
distributionrules_mcana <- validate::validator(
  ...
  DF_M_CANA = M_CANA <= (konst*validate::do_by(M_CANA, by = ANO, fun = zoo::rollmedian, k = 3, fill = NA, align = "right"))
)
...
distributionrules_mcfem <- validate::validator(
  ...
  DF_M_CFEM = M_CFEM <= (konst*validate::do_by(M_CFEM, by = ANO, fun = zoo::rollmedian, k = 3, fill = NA, align = "right"))
)
...
distributionrules_mcrh <- validate::validator(
  ...
  DF_M_CRH = M_CRH <= (konst*validate::do_by(M_CRH, by = ANO, fun = zoo::rollmedian, k = 3, fill = NA, align = "right"))
)
...
distributionrules_mflonativa <- validate::validator(
  ...
  DF_M_FLONATIVA = M_FLONATIVA <= (konst*validate::do_by(M_FLONATIVA, by = ANO, fun = zoo::rollmedian, k = 3, fill = NA, align = "right"))
)
...
distributionrules_mfocos <- validate::validator(
  ...
  DF_M_FOCOS = M_FOCOS <= (konst*validate::do_by(M_FOCOS, by = ANO, fun = zoo::rollmedian, k = 3, fill = NA, align = "right"))
)
...
distributionrules_mfrota <- validate::validator(
  ...
  DF_M_FROTA = M_FROTA <= (konst*validate::do_by(M_FROTA, by = ANO, fun = zoo::rollmedian, k = 3, fill = NA, align = "right"))
)
...
distributionrules_micmsecolog <- validate::validator(
  ...
  DF_M_ICMSECOLOG = M_ICMSECOLOG <= (konst*validate::do_by(M_ICMSECOLOG, by = ANO, fun = zoo::rollmedian, k = 3, fill = NA, align = "right"))
)
...
distributionrules_minfra <- validate::validator(
  ...
  DF_M_INFRA = M_INFRA <= (konst*validate::do_by(M_INFRA, by = ANO, fun = zoo::rollmedian, k = 3, fill = NA, align = "right"))
)
...
distributionrules_mreflo <- validate::validator(
  ...
  DF_M_REFLO = M_REFLO <= (konst*validate::do_by(M_REFLO, by = ANO, fun = zoo::rollmedian, k = 3, fill = NA, align = "right"))
)
