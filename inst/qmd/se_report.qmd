...
df_rules_valid_se_txbrutamortpad <- df_rules_valid_se_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::contains("_TXBRUTAMORTPAD")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("SE_")), 
    names_to  = "regra", 
...
df_rules_valid_se_txmoisqcor45a59 <- df_rules_valid_se_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::contains("_TXMOISQCOR45A59")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("SE_")), 
    names_to  = "regra", 
...
df_rules_valid_se_intmedcompldesmic <- df_rules_valid_se_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::contains("_INTMEDCOMPLDESMIC")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("SE_")), 
    names_to  = "regra", 
...
df_rules_valid_se_partodeslocmic <- df_rules_valid_se_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::contains("_PARTODESLOCMIC")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("SE_")), 
    names_to  = "regra", 
