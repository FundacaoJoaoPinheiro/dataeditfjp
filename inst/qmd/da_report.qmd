...
df_rules_valid_da_all <- data |> 
  ...
  dplyr::mutate(
    # Missing
    VI_NA_DA_POPT       = dplyr::if_else(!is.na(DA_POPT), F, T),
    VI_NA_DA_POPTA      = dplyr::if_else(!is.na(DA_POPTA), F, T),
    VI_NA_DA_POPP0      = dplyr::if_else(!is.na(DA_POPP0), F, T),
    VI_NA_DA_POPP1A4    = dplyr::if_else(!is.na(DA_POPP1A4), F, T),
    VI_NA_DA_POPP4      = dplyr::if_else(!is.na(DA_POPP4), F, T),
    VI_NA_DA_POPP5      = dplyr::if_else(!is.na(DA_POPP5), F, T),
    VI_NA_DA_POPP4E5    = dplyr::if_else(!is.na(DA_POPP4E5), F, T),
    VI_NA_DA_POPP5A9    = dplyr::if_else(!is.na(DA_POPP5A9), F, T),
    VI_NA_DA_POPP6A14   = dplyr::if_else(!is.na(DA_POPP6A14), F, T),
    VI_NA_DA_POPP10A14  = dplyr::if_else(!is.na(DA_POPP10A14), F, T),
    VI_NA_DA_POPP15     = dplyr::if_else(!is.na(DA_POPP15), F, T),
    VI_NA_DA_POPP15A17  = dplyr::if_else(!is.na(DA_POPP15A17), F, T),
    VI_NA_DA_POPP15A19  = dplyr::if_else(!is.na(DA_POPP15A19), F, T),
    VI_NA_DA_POPP15M    = dplyr::if_else(!is.na(DA_POPP15M), F, T),
    VI_NA_DA_POPP16A19  = dplyr::if_else(!is.na(DA_POPP16A19), F, T),
    VI_NA_DA_POPP16A64  = dplyr::if_else(!is.na(DA_POPP16A64), F, T),
    VI_NA_DA_POPP18M    = dplyr::if_else(!is.na(DA_POPP18M), F, T),
    VI_NA_DA_POPP20A24  = dplyr::if_else(!is.na(DA_POPP20A24), F, T),
    VI_NA_DA_POPP25A29  = dplyr::if_else(!is.na(DA_POPP25A29), F, T),
    VI_NA_DA_POPP30A34  = dplyr::if_else(!is.na(DA_POPP30A34), F, T),
    VI_NA_DA_POPP35A39  = dplyr::if_else(!is.na(DA_POPP35A39), F, T),
    VI_NA_DA_POPP40A44  = dplyr::if_else(!is.na(DA_POPP40A44), F, T),
    VI_NA_DA_POPP45A49  = dplyr::if_else(!is.na(DA_POPP45A49), F, T),
    VI_NA_DA_POPP50A54  = dplyr::if_else(!is.na(DA_POPP50A54), F, T),
    VI_NA_DA_POPP55A59  = dplyr::if_else(!is.na(DA_POPP55A59), F, T),
    VI_NA_DA_POPP60A64  = dplyr::if_else(!is.na(DA_POPP60A64), F, T),
    VI_NA_DA_POPP65A69  = dplyr::if_else(!is.na(DA_POPP65A69), F, T),
    VI_NA_DA_POPP70A74  = dplyr::if_else(!is.na(DA_POPP70A74), F, T),
    VI_NA_DA_POPP75A79  = dplyr::if_else(!is.na(DA_POPP75A79), F, T),
    VI_NA_DA_POPP80M    = dplyr::if_else(!is.na(DA_POPP80M), F, T),
    VI_NA_DA_DENSP      = dplyr::if_else(!is.na(DA_DENSP), F, T),
    VI_NA_DA_PROPP4E5   = dplyr::if_else(!is.na(DA_PROPP4E5), F, T),
    VI_NA_DA_PROPP0A5   = dplyr::if_else(!is.na(DA_PROPP0A5), F, T),
    VI_NA_DA_PROPP6A17  = dplyr::if_else(!is.na(DA_PROPP6A17), F, T),
    VI_NA_DA_RDEPP      = dplyr::if_else(!is.na(DA_RDEPP), F, T),
    VI_NA_DA_PROPP15N   = dplyr::if_else(!is.na(DA_PROPP15N), F, T),
    VI_NA_DA_PROPP65M   = dplyr::if_else(!is.na(DA_PROPP65M), F, T),
    VI_NA_DA_INDENVE    = dplyr::if_else(!is.na(DA_INDENVE), F, T),
    VI_NA_DA_POPPURB    = dplyr::if_else(!is.na(DA_POPPURB), F, T),
    VI_NA_DA_TFT        = dplyr::if_else(!is.na(DA_TFT), F, T),
    VI_NA_DA_TMI        = dplyr::if_else(!is.na(DA_TMI), F, T),
    VI_NA_DA_ESPVIDA    = dplyr::if_else(!is.na(DA_ESPVIDA), F, T),
    VI_NA_DA_TBM        = dplyr::if_else(!is.na(DA_TBM), F, T),
    VI_NA_DA_TBN        = dplyr::if_else(!is.na(DA_TBN), F, T),
    VI_NA_DA_TCV        = dplyr::if_else(!is.na(DA_TCV), F, T),
    VI_NA_DA_TLM        = dplyr::if_else(!is.na(DA_TLM), F, T),
    VI_NA_DA_TCD        = dplyr::if_else(!is.na(DA_TCD), F, T),
    VI_NA_DA_EMIGRA     = dplyr::if_else(!is.na(DA_EMIGRA), F, T),
    VI_NA_DA_IMIGRA     = dplyr::if_else(!is.na(DA_IMIGRA), F, T),
    VI_NA_DA_HOMEM0A4   = dplyr::if_else(!is.na(DA_HOMEM0A4), F, T),
    VI_NA_DA_HOMEM5A9   = dplyr::if_else(!is.na(DA_HOMEM5A9), F, T),
    VI_NA_DA_HOMEM10A14 = dplyr::if_else(!is.na(DA_HOMEM10A14), F, T),
    VI_NA_DA_HOMEM15A19 = dplyr::if_else(!is.na(DA_HOMEM15A19), F, T),
    VI_NA_DA_HOMEM20A24 = dplyr::if_else(!is.na(DA_HOMEM20A24), F, T),
    VI_NA_DA_HOMEM25A29 = dplyr::if_else(!is.na(DA_HOMEM25A29), F, T),
    VI_NA_DA_HOMEM30A34 = dplyr::if_else(!is.na(DA_HOMEM30A34), F, T),
    VI_NA_DA_HOMEM35A39 = dplyr::if_else(!is.na(DA_HOMEM35A39), F, T),
    VI_NA_DA_HOMEM40A44 = dplyr::if_else(!is.na(DA_HOMEM40A44), F, T),
    VI_NA_DA_HOMEM45A49 = dplyr::if_else(!is.na(DA_HOMEM45A49), F, T),
    VI_NA_DA_HOMEM50A54 = dplyr::if_else(!is.na(DA_HOMEM50A54), F, T),
    VI_NA_DA_HOMEM55A59 = dplyr::if_else(!is.na(DA_HOMEM55A59), F, T),
    VI_NA_DA_HOMEM60A64 = dplyr::if_else(!is.na(DA_HOMEM60A64), F, T),
    VI_NA_DA_HOMEM65A69 = dplyr::if_else(!is.na(DA_HOMEM65A69), F, T),
    VI_NA_DA_HOMEM70A74 = dplyr::if_else(!is.na(DA_HOMEM70A74), F, T),
    VI_NA_DA_HOMEM75A79 = dplyr::if_else(!is.na(DA_HOMEM75A79), F, T),
    VI_NA_DA_HOMEM80    = dplyr::if_else(!is.na(DA_HOMEM80), F, T),
    VI_NA_DA_MULH0A4    = dplyr::if_else(!is.na(DA_MULH0A4), F, T),
    VI_NA_DA_MULH5A9    = dplyr::if_else(!is.na(DA_MULH5A9), F, T),
    VI_NA_DA_MULH10A14  = dplyr::if_else(!is.na(DA_MULH10A14), F, T),
    VI_NA_DA_MULH15A19  = dplyr::if_else(!is.na(DA_MULH15A19), F, T),
    VI_NA_DA_MULH20A24  = dplyr::if_else(!is.na(DA_MULH20A24), F, T),
    VI_NA_DA_MULH25A29  = dplyr::if_else(!is.na(DA_MULH25A29), F, T),
    VI_NA_DA_MULH30A34  = dplyr::if_else(!is.na(DA_MULH30A34), F, T),
    VI_NA_DA_MULH35A39  = dplyr::if_else(!is.na(DA_MULH35A39), F, T),
    VI_NA_DA_MULH40A44  = dplyr::if_else(!is.na(DA_MULH40A44), F, T),
    VI_NA_DA_MULH45A49  = dplyr::if_else(!is.na(DA_MULH45A49), F, T),
    VI_NA_DA_MULH50A54  = dplyr::if_else(!is.na(DA_MULH50A54), F, T),
    VI_NA_DA_MULH55A59  = dplyr::if_else(!is.na(DA_MULH55A59), F, T),
    VI_NA_DA_MULH60A64  = dplyr::if_else(!is.na(DA_MULH60A64), F, T),
    VI_NA_DA_MULH65A69  = dplyr::if_else(!is.na(DA_MULH65A69), F, T),
    VI_NA_DA_MULH70A74  = dplyr::if_else(!is.na(DA_MULH70A74), F, T),
    VI_NA_DA_MULH75A79  = dplyr::if_else(!is.na(DA_MULH75A79), F, T),
    VI_NA_DA_MULHER80   = dplyr::if_else(!is.na(DA_MULHER80), F, T),
    VI_NA_DA_HOMEMTOT   = dplyr::if_else(!is.na(DA_HOMEMTOT), F, T),
    VI_NA_DA_MULHERTOT  = dplyr::if_else(!is.na(DA_MULHERTOT), F, T)
  )
```
