...
df_rules_valid_ma_all <- data |> 
  ...
  dplyr::mutate(
    # Missing
    VI_NA_MA_ICMSECOLOG = dplyr::if_else(!is.na(MA_ICMSECOLOG), F, T),
    VI_NA_MA_CRH        = dplyr::if_else(!is.na(MA_CRH), F, T),
    VI_NA_MA_CFEM       = dplyr::if_else(!is.na(MA_CFEM), F, T),
    VI_NA_MA_FOCOS      = dplyr::if_else(!is.na(MA_FOCOS), F, T),
    VI_NA_MA_CANA       = dplyr::if_else(!is.na(MA_CANA), F, T),
    VI_NA_MA_FROTA      = dplyr::if_else(!is.na(MA_FROTA), F, T),
    VI_NA_MA_BOVINO     = dplyr::if_else(!is.na(MA_BOVINO), F, T),
    VI_NA_MA_REFLO      = dplyr::if_else(!is.na(MA_REFLO), F, T),
    VI_NA_MA_FLONATIVA  = dplyr::if_else(!is.na(MA_FLONATIVA), F, T),
    VI_NA_MA_INFRA      = dplyr::if_else(!is.na(MA_INFRA), F, T),
    VI_NA_MA_AGRO       = dplyr::if_else(!is.na(MA_AGRO), F, T),
    # Others
...
df_rules_dist_ma_icmsecolog <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_MA_ICMSECOLOG_out_munic     = dplyr::if_else(!outlier_detection(MA_ICMSECOLOG), F, T), # Longitudinal (município)
...
df_rules_dist_ma_crh <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_MA_CRH_out_munic     = dplyr::if_else(!outlier_detection(MA_CRH), F, T), # Longitudinal (município)
...
df_rules_dist_ma_cfem <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_MA_CFEM_out_munic     = dplyr::if_else(!outlier_detection(MA_CFEM), F, T), # Longitudinal (município)
...
df_rules_dist_ma_focos <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_MA_FOCOS_out_munic     = dplyr::if_else(!outlier_detection(MA_FOCOS), F, T), # Longitudinal (município)
...
df_rules_dist_ma_cana <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_MA_CANA_out_munic     = dplyr::if_else(!outlier_detection(MA_CANA), F, T), # Longitudinal (município)
...
df_rules_dist_ma_frota <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_MA_FROTA_out_munic     = dplyr::if_else(!outlier_detection(MA_FROTA), F, T), # Longitudinal (município)
...
df_rules_dist_ma_bovino <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_MA_BOVINO_out_munic     = dplyr::if_else(!outlier_detection(MA_BOVINO), F, T), # Longitudinal (município)
...
df_rules_dist_ma_reflo <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_MA_REFLO_out_munic     = dplyr::if_else(!outlier_detection(MA_REFLO), F, T), # Longitudinal (município)
...
df_rules_dist_ma_flonativa <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_MA_FLONATIVA_out_munic     = dplyr::if_else(!outlier_detection(MA_FLONATIVA), F, T), # Longitudinal (município)
...
df_rules_dist_ma_infra <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_MA_INFRA_out_munic     = dplyr::if_else(!outlier_detection(MA_INFRA), F, T), # Longitudinal (município)
...
df_rules_dist_ma_agro <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_MA_AGRO_out_munic     = dplyr::if_else(!outlier_detection(MA_AGRO), F, T), # Longitudinal (município)
...
## Validade
df_rules_valid_ma_icmsecolog <- df_rules_valid_ma_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("MA_ICMSECOLOG")
  ) |> 
  tidyr::pivot_longer(
...
df_rules_valid_ma_cfem <- df_rules_valid_ma_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("MA_CFEM")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("MA_")), 
    names_to  = "regra", 
...
df_rules_valid_ma_focos <- df_rules_valid_ma_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("MA_FOCOS")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("MA_")), 
    names_to  = "regra", 
...
lista_df <- list(
  "ma_icmsecolog" = df_rules_valid_ma_icmsecolog,
  "ma_crh"        = df_rules_valid_ma_crh,
  "ma_cfem"       = df_rules_valid_ma_cfem,
...
## Distribuição
df_rules_dist_ma_icmsecolog <- df_rules_dist_ma_icmsecolog |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("MA_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_ma_cfem <- df_rules_dist_ma_cfem |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("MA_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_ma_focos <- df_rules_dist_ma_focos |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("MA_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
