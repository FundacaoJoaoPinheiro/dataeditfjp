...
df_rules_valid_ea_all <- data |> 
  ...
  dplyr::mutate(
    # Missing
    VI_NA_SP_CV            = dplyr::if_else(!is.na(SP_CV), F, T),
    VI_NA_SP_CVPA          = dplyr::if_else(!is.na(SP_CVPA), F, T),
    VI_NA_SP_CVPE          = dplyr::if_else(!is.na(SP_CVPE), F, T),
    VI_NA_SP_MPO           = dplyr::if_else(!is.na(SP_MPO), F, T),
    VI_NA_SP_HOMTX         = dplyr::if_else(!is.na(SP_HOMTX), F, T),
    VI_NA_SP_HOMI          = dplyr::if_else(!is.na(SP_HOMI), F, T),
    VI_NA_SP_TENHOM        = dplyr::if_else(!is.na(SP_TENHOM), F, T),
    VI_NA_SP_LATROCINIO    = dplyr::if_else(!is.na(SP_LATROCINIO), F, T),
    VI_NA_SP_ROUBO         = dplyr::if_else(!is.na(SP_ROUBO), F, T),
    VI_NA_SP_TRAFICO       = dplyr::if_else(!is.na(SP_TRAFICO), F, T),
    VI_NA_SP_POSSE         = dplyr::if_else(!is.na(SP_POSSE), F, T),
    VI_NA_SP_ARMA          = dplyr::if_else(!is.na(SP_ARMA), F, T),
    VI_NA_SP_ESTUPRO       = dplyr::if_else(!is.na(SP_ESTUPRO), F, T),
    VI_NA_SP_SUICIDIOSSIM  = dplyr::if_else(!is.na(SP_SUICIDIOSSIM), F, T),
    VI_NA_SP_MORTESTRANSIM = dplyr::if_else(!is.na(SP_MORTESTRANSIM), F, T),
    VI_NA_SP_HOMISIM       = dplyr::if_else(!is.na(SP_HOMISIM), F, T),
    VI_NA_SP_HOMITXSIM     = dplyr::if_else(!is.na(SP_HOMITXSIM), F, T),
    VI_NA_SP_HOMMENOR15SIM = dplyr::if_else(!is.na(SP_HOMMENOR15SIM), F, T),
    VI_NA_SP_HOM15A24SIM   = dplyr::if_else(!is.na(SP_HOM15A24SIM), F, T),
    VI_NA_SP_HOM25A29SIM   = dplyr::if_else(!is.na(SP_HOM25A29SIM), F, T),
    VI_NA_SP_HOMMAIOR30SIM = dplyr::if_else(!is.na(SP_HOMMAIOR30SIM), F, T),
    VI_NA_SP_HOMBRANCASIM  = dplyr::if_else(!is.na(SP_HOMBRANCASIM), F, T),
    VI_NA_SP_HOMPRETASIM   = dplyr::if_else(!is.na(SP_HOMPRETASIM), F, T),
    VI_NA_SP_HOMPARDASIM   = dplyr::if_else(!is.na(SP_HOMPARDASIM), F, T),
    VI_NA_SP_HOMOUTROSSIM  = dplyr::if_else(!is.na(SP_HOMOUTROSSIM), F, T),
    VI_NA_SP_HOMHOMEMSIM   = dplyr::if_else(!is.na(SP_HOMHOMEMSIM), F, T),
    VI_NA_SP_HOMMULHERSIM  = dplyr::if_else(!is.na(SP_HOMMULHERSIM), F, T),
    VI_NA_SP_PM            = dplyr::if_else(!is.na(SP_PM), F, T),
    VI_NA_SP_PM1           = dplyr::if_else(!is.na(SP_PM1), F, T),
    VI_NA_SP_PC1           = dplyr::if_else(!is.na(SP_PC1), F, T),
    VI_NA_SP_PMPC          = dplyr::if_else(!is.na(SP_PMPC), F, T),
    VI_NA_SP_NATPM         = dplyr::if_else(!is.na(SP_NATPM), F, T),
    VI_NA_SP_DELEGACIA     = dplyr::if_else(!is.na(SP_DELEGACIA), F, T),
    VI_NA_SP_INF           = dplyr::if_else(!is.na(SP_INF), F, T),
    VI_NA_SP_PEN           = dplyr::if_else(!is.na(SP_PEN), F, T),
    VI_NA_SP_PRESOSPC      = dplyr::if_else(!is.na(SP_PRESOSPC), F, T),
    VI_NA_SP_OCUPPC        = dplyr::if_else(!is.na(SP_OCUPPC), F, T),
    VI_NA_SP_PRESOSSUAPI   = dplyr::if_else(!is.na(SP_PRESOSSUAPI), F, T),
    VI_NA_SP_OCUPSUAPI     = dplyr::if_else(!is.na(SP_OCUPSUAPI), F, T),
    VI_NA_SP_COMARCA       = dplyr::if_else(!is.na(SP_COMARCA), F, T),
    # Others
    ...
    VI_SP_PM1              = dplyr::if_else(SP_PM1 >= 10, F, T),
    VI_SP_PC1              = dplyr::if_else(SP_PC1 >= 10, F, T),
...
df_rules_dist_sp_cv <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_CV_out_munic     = dplyr::if_else(!outlier_detection(SP_CV), F, T), # Longitudinal (município)
...
df_rules_dist_sp_cvpa <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_CVPA_out_munic     = dplyr::if_else(!outlier_detection(SP_CVPA), F, T), # Longitudinal (município)
...
df_rules_dist_sp_cvpe <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_CVPE_out_munic     = dplyr::if_else(!outlier_detection(SP_CVPE), F, T), # Longitudinal (município)
...
df_rules_dist_sp_mpo <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_MPO_out_munic     = dplyr::if_else(!outlier_detection(SP_MPO), F, T), # Longitudinal (município)
...
df_rules_dist_sp_homtx <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOMTX_out_munic     = dplyr::if_else(!outlier_detection(SP_HOMTX), F, T), # Longitudinal (município)
...
df_rules_dist_sp_homi <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOMI_out_munic     = dplyr::if_else(!outlier_detection(SP_HOMI), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_tenhom <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_TENHOM_out_munic     = dplyr::if_else(!outlier_detection(SP_TENHOM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_latrocinio <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_LATROCINIO_out_munic     = dplyr::if_else(!outlier_detection(SP_LATROCINIO), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_roubo <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_ROUBO_out_munic     = dplyr::if_else(!outlier_detection(SP_ROUBO), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_trafico <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_TRAFICO_out_munic     = dplyr::if_else(!outlier_detection(SP_TRAFICO), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_posse <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_POSSE_out_munic     = dplyr::if_else(!outlier_detection(SP_POSSE), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_arma <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_ARMA_out_munic     = dplyr::if_else(!outlier_detection(SP_ARMA), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_estupro <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_ESTUPRO_out_munic     = dplyr::if_else(!outlier_detection(SP_ESTUPRO), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_suicidiossim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_SUICIDIOSSIM_out_munic     = dplyr::if_else(!outlier_detection(SP_SUICIDIOSSIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_mortestransim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_MORTESTRANSIM_out_munic     = dplyr::if_else(!outlier_detection(SP_MORTESTRANSIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_homisim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOMISIM_out_munic     = dplyr::if_else(!outlier_detection(SP_HOMISIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_homitxsim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOMITXSIM_out_munic     = dplyr::if_else(!outlier_detection(SP_HOMITXSIM), F, T), # Longitudinal (município)
...
df_rules_dist_sp_hommenor15sim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOMMENOR15SIM_out_munic     = dplyr::if_else(!outlier_detection(SP_HOMMENOR15SIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_hom15a24sim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOM15A24SIM_out_munic     = dplyr::if_else(!outlier_detection(SP_HOM15A24SIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_hom25a29sim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOM25A29SIM_out_munic     = dplyr::if_else(!outlier_detection(SP_HOM25A29SIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_hommaior30sim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOMMAIOR30SIM_out_munic     = dplyr::if_else(!outlier_detection(SP_HOMMAIOR30SIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_hombrancasim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOMBRANCASIM_out_munic     = dplyr::if_else(!outlier_detection(SP_HOMBRANCASIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_hompretasim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOMPRETASIM_out_munic     = dplyr::if_else(!outlier_detection(SP_HOMPRETASIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_hompardasim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOMPARDASIM_out_munic     = dplyr::if_else(!outlier_detection(SP_HOMPARDASIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_homoutrossim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOMOUTROSSIM_out_munic     = dplyr::if_else(!outlier_detection(SP_HOMOUTROSSIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_homhomemsim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOMHOMEMSIM_out_munic     = dplyr::if_else(!outlier_detection(SP_HOMHOMEMSIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_hommulhersim <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_HOMMULHERSIM_out_munic     = dplyr::if_else(!outlier_detection(SP_HOMMULHERSIM), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_pm <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_PM_out_munic     = dplyr::if_else(!outlier_detection(SP_PM), F, T), # Longitudinal (município)
...
df_rules_dist_sp_pm1 <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_PM1_out_munic     = dplyr::if_else(!outlier_detection(SP_PM1), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_pc1 <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_PC1_out_munic     = dplyr::if_else(!outlier_detection(SP_PC1), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_pmpc <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_PMPC_out_munic     = dplyr::if_else(!outlier_detection(SP_PMPC), F, T), # Longitudinal (município)
...
df_rules_dist_sp_jui2 <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_JUI2_out_munic     = dplyr::if_else(!outlier_detection(SP_JUI2), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_pro2 <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_PRO2_out_munic     = dplyr::if_else(!outlier_detection(SP_PRO2), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_defp2 <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_DEFP2_out_munic     = dplyr::if_else(!outlier_detection(SP_DEFP2), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_presospc <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_PRESOSPC_out_munic     = dplyr::if_else(!outlier_detection(SP_PRESOSPC), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_ocuppc <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_OCUPPC_out_munic     = dplyr::if_else(!outlier_detection(SP_OCUPPC), F, T), # Longitudinal (município)
...
df_rules_dist_sp_presossuapi <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_PRESOSSUAPI_out_munic     = dplyr::if_else(!outlier_detection(SP_PRESOSSUAPI), F, T) # Longitudinal (município)
  )
```
...
df_rules_dist_sp_ocupsuapi <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_SP_OCUPSUAPI_out_munic     = dplyr::if_else(!outlier_detection(SP_OCUPSUAPI), F, T), # Longitudinal (município)
...
## Validade
df_rules_valid_sp_cv <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_cvpa <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_cvpe <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_mpo <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_homtx <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_homi <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_tenhom <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_latrocinio <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_roubo <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_trafico <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_posse <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_arma <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_estupro <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_suicidiossim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_mortestransim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_homisim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_homitxsim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_hommenor15sim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_hom15a24sim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_hom25a29sim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_hommaior30sim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_hombrancasim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_hompretasim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_hompardasim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_homoutrossim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_homhomemsim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_hommulhersim <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_pm <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_pm1 <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_pc1 <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_pmpc <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_jui2 <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_pro2 <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_defp2 <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_natpm <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_delegacia <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_inf <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_pen <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_presospc <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_ocuppc <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_presossuapi <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_ocupsuapi <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
...
df_rules_valid_sp_comarca <- df_rules_valid_ea_all |> 
  dplyr::select(
    Ano,
    ibge7,
