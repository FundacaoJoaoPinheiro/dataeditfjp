...
#   "SP_ARMA"          = 2012,      
#   "SP_ESTUPRO"       = 2012,     
#   "SP_SUICIDIOSSIM"  = 2012,    #APARTIR DAQUI    
...
df_dist <- list(
  "SP_CV"              = df_rules_dist_sp_indcras,
  "SP_CVPA"             = df_rules_dist_sp_idcrasme,
  "SP_CVPE"           = df_rules_dist_sp_idcreasnor,
  "SP_MPO"           = df_rules_dist_sp_idconselho,
  "SP_HOMTX"                 = df_rules_dist_sp_igdm,
  "SP_HOMI"             = df_rules_dist_sp_igdsuasm,
  "SP_TENHOM"                = df_rules_dist_sp_ncras,
  "SP_LATROCINIO"               = df_rules_dist_sp_ncreas,
  "SP_ROUBO"          = df_rules_dist_sp_fcadmeiosal,
  "SP_TRAFICO"             = df_rules_dist_sp_rhtotala,
  "SP_POSSE"             = df_rules_dist_sp_rhtotalb,
  "SP_"                 = df_rules_dist_sp_rhas,
  "SP_"                = df_rules_dist_sp_rhpsi,
  "SP_ "               = df_rules_dist_sp_rhenme,
  "SP_ "              = df_rules_dist_sp_rhenme,
  "SP_ "              = df_rules_dist_sp_rhtoest,
  "SP_ "              = df_rules_dist_sp_rhtocel,
  "SP_ "               = df_rules_dist_sp_bpcdef,
  "SP_ "                = df_rules_dist_sp_bpcid,
  "SP_ "                  = df_rules_dist_sp_bpc,
  "SP_ "            = df_rules_dist_sp_rhtpoasph,
  "SP_ "            = df_rules_dist_sp_bpcidpopi,
  "SP_ "          = df_rules_dist_sp_popcadunico,
  "SP_ "                = df_rules_dist_sp_cobbf,
  "SP_ "         = df_rules_dist_sp_popidcadspop,
  "SP_ "          = df_rules_dist_sp_popruralpop,
  "SP_ "        = df_rules_dist_sp_poppobextrpob,
  "SP_ "        = df_rules_dist_sp_pcobbfmeiosal,
  "SP_ "        = df_rules_dist_sp_poppobextrcad,
  "SP_ "      = df_rules_dist_sp_popidpobextrcad,
  "SP_ "  = df_rules_dist_sp_idosopobextrpobcads,
  "SP_ "        = df_rules_dist_sp_defpobextrcad,
  "SP_ " = df_rules_dist_sp_crianadolepobextrpop,
  "SP_ "     = df_rules_dist_sp_popidpobextrcads,
  "SP_ "            = df_rules_dist_sp_popidcads,
  "SP_ "          = df_rules_dist_sp_efincompcad,
  "SP_ "             = df_rules_dist_sp_penlecad,
  "SP_ "      = df_rules_dist_sp_popindigenacads,
  "SP_ "    = df_rules_dist_sp_poppretapardacads,
  "SP_ "         = df_rules_dist_sp_pvulsaneacad,
  "SP_ "             = df_rules_dist_sp_saneacad,
  "SP_ "         = df_rules_dist_sp_popruralcads,
  "SP_ "            = df_rules_dist_sp_igdmconde,
  "SP_ "            = df_rules_dist_sp_igdmconds,
  "SP_ "              = df_rules_dist_sp_igdmatu,
  "SP_ "           = df_rules_dist_sp_igdmcobcad,
  "SP_ "               = df_rules_dist_sp_bpcpid,
  "SP_ "              = df_rules_dist_sp_bpcpdef,
  "SP_ "               = df_rules_dist_sp_rhasps,
  "SP_ "              = df_rules_dist_sp_rhpsips,
  "SP_ "             = df_rules_dist_sp_rhvpoaas,
  "SP_ "             = df_rules_dist_sp_rhvinest )
