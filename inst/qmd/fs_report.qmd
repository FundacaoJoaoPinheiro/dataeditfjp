...
format: 
  html:
    ...
    theme:
      light: [flatly, css/fs_custom.scss]
editor: visual
execute:
  echo: false
  warning: false
...
df_rules_valid_fs_all <- data |> 
  ...
  dplyr::mutate(
    # Missing
    VI_NA_FS_PES         = dplyr::if_else(!is.na(FS_PES), F, NA),
    VI_NA_FS_DCLRCL      = dplyr::if_else(!is.na(FS_DCLRCL), F, NA),
    VI_NA_FS_OCDC        = dplyr::if_else(!is.na(FS_OCDC), F, NA),
    VI_NA_FS_EQUILF      = dplyr::if_else(!is.na(FS_EQUILF), F, NA),
    VI_NA_FS_GLPC        = dplyr::if_else(!is.na(FS_GLPC), F, NA),
    VI_NA_FS_GLEC25      = dplyr::if_else(!is.na(FS_GLEC25), F, NA),
    VI_NA_FS_CUSTRCL     = dplyr::if_else(!is.na(FS_CUSTRCL), F, NA),
    VI_NA_FS_IGT         = dplyr::if_else(!is.na(FS_IGT), F, NA),
    VI_NA_FS_GEDUC       = dplyr::if_else(!is.na(FS_GEDUC), F, NA),
    VI_NA_FS_GSAUDE      = dplyr::if_else(!is.na(FS_GSAUDE), F, NA),
    VI_NA_FS_CONVRCL     = dplyr::if_else(!is.na(FS_CONVRCL), F, NA),
    VI_NA_FS_IDTE        = dplyr::if_else(!is.na(FS_IDTE), F, NA),
    VI_NA_FS_RCL         = dplyr::if_else(!is.na(FS_RCL), F, NA),
    VI_NA_FS_RCLPC       = dplyr::if_else(!is.na(FS_RCLPC), F, NA),
    VI_NA_FS_AGRO        = dplyr::if_else(!is.na(FS_AGRO), F, NA),
    VI_NA_FS_DESENV      = dplyr::if_else(!is.na(FS_DESENV), F, NA),
    VI_NA_FS_DIFCULT     = dplyr::if_else(!is.na(FS_DIFCULT), F, NA),
    VI_NA_FS_EDUCACAO    = dplyr::if_else(!is.na(FS_EDUCACAO), F, NA),
    VI_NA_FS_ESPORTE     = dplyr::if_else(!is.na(FS_ESPORTE), F, NA),
    VI_NA_FS_HABITA      = dplyr::if_else(!is.na(FS_HABITA), F, NA),
    VI_NA_FS_INFRA       = dplyr::if_else(!is.na(FS_INFRA), F, NA),
    VI_NA_FS_OUTRAS      = dplyr::if_else(!is.na(FS_OUTRAS), F, NA),
    VI_NA_FS_PATRI       = dplyr::if_else(!is.na(FS_PATRI), F, NA),
    VI_NA_FS_REFAGR      = dplyr::if_else(!is.na(FS_REFAGR), F, NA),
    VI_NA_FS_SANEAMENTO  = dplyr::if_else(!is.na(FS_SANEAMENTO), F, NA),
    VI_NA_FS_SAUDE       = dplyr::if_else(!is.na(FS_SAUDE), F, NA),
    VI_NA_FS_SEGURAN     = dplyr::if_else(!is.na(FS_SEGURAN), F, NA),
    VI_NA_FS_SMAMB       = dplyr::if_else(!is.na(FS_SMAMB), F, NA),
    VI_NA_FS_SOCIAL      = dplyr::if_else(!is.na(FS_SOCIAL), F, NA),
    VI_NA_FS_TOTAL       = dplyr::if_else(!is.na(FS_TOTAL), F, NA),
    VI_NA_FS_TRAB        = dplyr::if_else(!is.na(FS_TRAB), F, NA),
    VI_NA_FS_TURISMO     = dplyr::if_else(!is.na(FS_TURISMO), F, NA),
    VI_NA_FS_EAGRO       = dplyr::if_else(!is.na(FS_EAGRO), F, NA),
    VI_NA_FS_EDESENV     = dplyr::if_else(!is.na(FS_EDESENV), F, NA),
    VI_NA_FS_EDIFCULT    = dplyr::if_else(!is.na(FS_EDIFCULT), F, NA),
    VI_NA_FS_EEDUCACAO   = dplyr::if_else(!is.na(FS_EEDUCACAO), F, NA),
    VI_NA_FS_EESPORTE    = dplyr::if_else(!is.na(FS_EESPORTE), F, NA),
    VI_NA_FS_EHABITA     = dplyr::if_else(!is.na(FS_EHABITA), F, NA),
    VI_NA_FS_EINFRA      = dplyr::if_else(!is.na(FS_EINFRA), F, NA),
    VI_NA_FS_EOUTRAS     = dplyr::if_else(!is.na(FS_EOUTRAS), F, NA),
    VI_NA_FS_EPATRI      = dplyr::if_else(!is.na(FS_EPATRI), F, NA),
    VI_NA_FS_EREFAGR     = dplyr::if_else(!is.na(FS_EREFAGR), F, NA),
    VI_NA_FS_ESANEAMENTO = dplyr::if_else(!is.na(FS_ESANEAMENTO), F, NA),
    VI_NA_FS_ESAUDE      = dplyr::if_else(!is.na(FS_ESAUDE), F, NA),
    VI_NA_FS_ESEGURAN    = dplyr::if_else(!is.na(FS_ESEGURAN), F, NA),
    VI_NA_FS_ESMAMB      = dplyr::if_else(!is.na(FS_ESMAMB), F, NA),
    VI_NA_FS_ESOCIAL     = dplyr::if_else(!is.na(FS_ESOCIAL), F, NA),
    VI_NA_FS_ETRAB       = dplyr::if_else(!is.na(FS_ETRAB), F, NA),
    VI_NA_FS_ETURISMO    = dplyr::if_else(!is.na(FS_ETURISMO), F, NA),
    VI_NA_FS_EHABSANMA   = dplyr::if_else(!is.na(FS_EHABSANMA), F, NA),
    # Others
...
```{r data_wrangling_consist_fs_all}

# ## Tranformação dos resultados
# df_sumario_consist_fs <- df_rules_consist_fs_all |> 
#   dplyr::select(!MA_FOCOS) |> 
#   tidyr::pivot_longer(cols = !c(Ano, ibge7), names_to = "Regra", values_to = "resultado")
# 
# ## df com um sumário dos resultados
# df_sumario <- df_sumario_consist_fs |> 
#   dplyr::group_by(Ano, Regra) |> 
#   dplyr::summarise(
#     Total        = dplyr::n(),
#     Validada     = sum(!resultado, na.rm = T),
...
## Validade
df_rules_valid_fs_pes <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_PES")
  ) |> 
  tidyr::pivot_longer(
...
df_rules_valid_fs_dclrcl <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_DCLRCL")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_ocdc <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_OCDC")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_equilf <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EQUILF")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_glpc <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_GLPC")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_glec25 <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_GLEC25")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_custrcl <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_CUSTRCL")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_igt <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_IGT")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_geduc <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_GEDUC")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_gsaude <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_GSAUDE")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_convrcl <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_CONVRCL")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_idte <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_IDTE")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_rcl <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_RCL")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_rclpc <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_RCLPC")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_agro <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_AGRO")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_desenv <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_DESENV")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_difcult <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_DIFCULT")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_educacao <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EDUCACAO")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_esporte <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_ESPORTE")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_habita <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_HABITA")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_infra <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_INFRA")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_outras <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_OUTRAS")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_patri <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_PATRI")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_refagr <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_REFAGR")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_saneamento <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_SANEAMENTO")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_saude <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_SAUDE")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_seguran <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_SEGURAN")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_smamb <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_SMAMB")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_social <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_SOCIAL")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_total <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_TOTAL")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_trab <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_TRAB")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_turismo <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_TURISMO")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_eagro <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EAGRO")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_edesenv <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EDESENV")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_edifcult <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EDIFCULT")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_eeducacao <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EEDUCACAO")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_eesporte <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EESPORTE")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_ehabita <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EHABITA")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_einfra <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EINFRA")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_eoutras <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EOUTRAS")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_epatri <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EPATRI")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_erefagr <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EREFAGR")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_esaneamento <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_ESANEAMENTO")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_esaude <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_ESAUDE")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_eseguran <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_ESEGURAN")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_esmamb <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_ESMAMB")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_esocial <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_ESOCIAL")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_etrab <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_ETRAB")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_eturismo <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_ETURISMO")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
df_rules_valid_fs_ehabsanma <- df_rules_valid_fs_all |> 
  dplyr::select(
    Ano,
    ibge7,
    dplyr::ends_with("FS_EHABSANMA")
  ) |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
...
lista_df <- list(
  "fs_pes"         = df_rules_valid_fs_pes,
  "fs_dclrcl"      = df_rules_valid_fs_dclrcl,
  "fs_ocdc"        = df_rules_valid_fs_ocdc,
  "fs_equilf"      = df_rules_valid_fs_equilf,
  "fs_glpc"        = df_rules_valid_fs_glpc,
  "fs_glec25"      = df_rules_valid_fs_glec25,
  "fs_custrcl"     = df_rules_valid_fs_custrcl,
  "fs_igt"         = df_rules_valid_fs_igt,
  "fs_geduc"       = df_rules_valid_fs_geduc,
  "fs_gsaude"      = df_rules_valid_fs_gsaude,
  "fs_convrcl"     = df_rules_valid_fs_convrcl,
  "fs_idte"        = df_rules_valid_fs_idte,
  "fs_rcl"         = df_rules_valid_fs_rcl,
  "fs_rclpc"       = df_rules_valid_fs_rclpc,
  "fs_agro"        = df_rules_valid_fs_agro,
  "fs_desenv"      = df_rules_valid_fs_desenv,
  "fs_difcult"     = df_rules_valid_fs_difcult,
  "fs_educacao"    = df_rules_valid_fs_educacao,
  "fs_esporte"     = df_rules_valid_fs_esporte,
  "fs_habita"      = df_rules_valid_fs_habita,
  "fs_infra"       = df_rules_valid_fs_infra,
  "fs_outras"      = df_rules_valid_fs_outras,
  "fs_patri"       = df_rules_valid_fs_patri,
  "fs_refagr"      = df_rules_valid_fs_refagr,
  "fs_saneamento"  = df_rules_valid_fs_saneamento,
  "fs_saude"       = df_rules_valid_fs_saude,
  "fs_seguran"     = df_rules_valid_fs_seguran,
  "fs_smamb"       = df_rules_valid_fs_smamb,
  "fs_social"      = df_rules_valid_fs_social,
  "fs_total"       = df_rules_valid_fs_total,
  "fs_trab"        = df_rules_valid_fs_trab,
  "fs_turismo"     = df_rules_valid_fs_turismo,
  "fs_eagro"       = df_rules_valid_fs_eagro,
  "fs_edesenv"     = df_rules_valid_fs_edesenv,
  "fs_edifcult"    = df_rules_valid_fs_edifcult,
  "fs_eeducacao"   = df_rules_valid_fs_eeducacao,
  "fs_eesporte"    = df_rules_valid_fs_eesporte,
  "fs_ehabita"     = df_rules_valid_fs_ehabita,
  "fs_einfra"      = df_rules_valid_fs_einfra,
  "fs_eoutras"     = df_rules_valid_fs_eoutras,
  "fs_epatri"      = df_rules_valid_fs_epatri,
  "fs_erefagr"     = df_rules_valid_fs_erefagr,
  "fs_esaneamento" = df_rules_valid_fs_esaneamento,
  "fs_esaude"      = df_rules_valid_fs_esaude,
  "fs_eseguran"    = df_rules_valid_fs_eseguran,
  "fs_esmamb"      = df_rules_valid_fs_esmamb,
  "fs_esocial"     = df_rules_valid_fs_esocial,
  "fs_etrab"       = df_rules_valid_fs_etrab,
  "fs_eturismo"    = df_rules_valid_fs_eturismo,
  "fs_ehabsanma"   = df_rules_valid_fs_ehabsanma
)
...
## Distribuição
df_rules_dist_fs_pes <- df_rules_dist_fs_pes |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_dclrcl <- df_rules_dist_fs_dclrcl |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_ocdc <- df_rules_dist_fs_ocdc |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_equilf <- df_rules_dist_fs_equilf |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_glpc <- df_rules_dist_fs_glpc |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_glec25 <- df_rules_dist_fs_glec25 |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_custrcl <- df_rules_dist_fs_custrcl |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_igt <- df_rules_dist_fs_igt |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_geduc <- df_rules_dist_fs_geduc |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_gsaude <- df_rules_dist_fs_gsaude |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_convrcl <- df_rules_dist_fs_convrcl |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_idte <- df_rules_dist_fs_idte |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_rcl <- df_rules_dist_fs_rcl |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_rclpc <- df_rules_dist_fs_rclpc |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_agro <- df_rules_dist_fs_agro |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_desenv <- df_rules_dist_fs_desenv |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_difcult <- df_rules_dist_fs_difcult |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_educacao <- df_rules_dist_fs_educacao |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_esporte <- df_rules_dist_fs_esporte |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_habita <- df_rules_dist_fs_habita |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_infra <- df_rules_dist_fs_infra |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_outras <- df_rules_dist_fs_outras |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_patri <- df_rules_dist_fs_patri |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_refagr <- df_rules_dist_fs_refagr |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_saneamento <- df_rules_dist_fs_saneamento |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_saude <- df_rules_dist_fs_saude |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_seguran <- df_rules_dist_fs_seguran |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_smamb <- df_rules_dist_fs_smamb |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_social <- df_rules_dist_fs_social |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_total <- df_rules_dist_fs_total |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_trab <- df_rules_dist_fs_trab |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_turismo <- df_rules_dist_fs_turismo |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_eagro <- df_rules_dist_fs_eagro |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_edesenv <- df_rules_dist_fs_edesenv |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_edifcult <- df_rules_dist_fs_edifcult |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_eeducacao <- df_rules_dist_fs_eeducacao |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_eesporte <- df_rules_dist_fs_eesporte |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_ehabita <- df_rules_dist_fs_ehabita |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_einfra <- df_rules_dist_fs_einfra |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_eoutras <- df_rules_dist_fs_eoutras |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_epatri <- df_rules_dist_fs_epatri |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_erefagr <- df_rules_dist_fs_erefagr |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_esaneamento <- df_rules_dist_fs_esaneamento |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_esaude <- df_rules_dist_fs_esaude |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_eseguran <- df_rules_dist_fs_eseguran |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_esmamb <- df_rules_dist_fs_esmamb |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_esocial <- df_rules_dist_fs_esocial |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_etrab <- df_rules_dist_fs_etrab |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_eturismo <- df_rules_dist_fs_eturismo |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
df_rules_dist_fs_ehabsanma <- df_rules_dist_fs_ehabsanma |> 
  tidyr::pivot_longer(
    cols      = !c(Ano, ibge7, dplyr::starts_with("FS_")), 
    names_to  = "regra", 
    values_to = "obs_suspeita"
...
lista_df <- list(
  ...
  "fs_convrcl"     = df_rules_dist_fs_convrcl,
  "fs_idte"        = df_rules_dist_fs_idte,
  "fs_rcl"         = df_rules_dist_fs_rcl,
  "fs_rclpc"       = df_rules_dist_fs_rclpc,
  "fs_agro"        = df_rules_dist_fs_agro,
  "fs_desenv"      = df_rules_dist_fs_desenv,
  "fs_difcult"     = df_rules_dist_fs_difcult,
  "fs_educacao"    = df_rules_dist_fs_educacao,
  "fs_esporte"     = df_rules_dist_fs_esporte,
  "fs_habita"      = df_rules_dist_fs_habita,
  "fs_infra"       = df_rules_dist_fs_infra,
  "fs_outras"      = df_rules_dist_fs_outras,
  "fs_patri"       = df_rules_dist_fs_patri,
  "fs_refagr"      = df_rules_dist_fs_refagr,
  "fs_saneamento"  = df_rules_dist_fs_saneamento,
  "fs_saude"       = df_rules_dist_fs_saude,
  "fs_seguran"     = df_rules_dist_fs_seguran,
  "fs_smamb"       = df_rules_dist_fs_smamb,
  "fs_social"      = df_rules_dist_fs_social,
  "fs_total"       = df_rules_dist_fs_total,
  "fs_trab"        = df_rules_dist_fs_trab,
  "fs_turismo"     = df_rules_dist_fs_turismo,
  "fs_eagro"       = df_rules_dist_fs_eagro,
  "fs_edesenv"     = df_rules_dist_fs_edesenv,
  "fs_edifcult"    = df_rules_dist_fs_edifcult,
  "fs_eeducacao"   = df_rules_dist_fs_eeducacao,
  "fs_eesporte"    = df_rules_dist_fs_eesporte,
  "fs_ehabita"     = df_rules_dist_fs_ehabita,
  "fs_einfra"      = df_rules_dist_fs_einfra,
  "fs_eoutras"     = df_rules_dist_fs_eoutras,
  "fs_epatri"      = df_rules_dist_fs_epatri,
  "fs_erefagr"     = df_rules_dist_fs_erefagr,
  "fs_esaneamento" = df_rules_dist_fs_esaneamento,
  "fs_esaude"      = df_rules_dist_fs_esaude,
  "fs_eseguran"    = df_rules_dist_fs_eseguran,
  "fs_esmamb"      = df_rules_dist_fs_esmamb,
  "fs_esocial"     = df_rules_dist_fs_esocial,
  "fs_etrab"       = df_rules_dist_fs_etrab,
  "fs_eturismo"    = df_rules_dist_fs_eturismo,
  "fs_ehabsanma"   = df_rules_dist_fs_ehabsanma
)
...
openxlsx::saveWorkbook(pt, "fjpdados_financas_violacoes.xlsx", overwrite = T)
```
