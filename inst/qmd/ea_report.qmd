...
df_rules_valid_ea_all <- data |> 
  ...
  dplyr::mutate(
    # Missing
    VI_NA_EA_BFFAM    = dplyr::if_else(!is.na(EA_BFFAM), F, T),
    VI_NA_EA_TRFAM    = dplyr::if_else(!is.na(EA_TRFAM), F, T),
    VI_NA_EA_TRPF     = dplyr::if_else(!is.na(EA_TRPF), F, T),
    VI_NA_EA_BPCDEF   = dplyr::if_else(!is.na(EA_BPCDEF), F, T),
    VI_NA_EA_BPCIDO   = dplyr::if_else(!is.na(EA_BPCIDO), F, T),
    VI_NA_EA_BFBPC    = dplyr::if_else(!is.na(EA_BFBPC), F, T),
    VI_NA_EA_TRBPCDEF = dplyr::if_else(!is.na(EA_TRBPCDEF), F, T),
    VI_NA_EA_TRBPCIDO = dplyr::if_else(!is.na(EA_TRBPCIDO), F, T),
    VI_NA_EA_TRBPC    = dplyr::if_else(!is.na(EA_TRBPC), F, T),
    VI_NA_EA_TRBPCPB  = dplyr::if_else(!is.na(EA_TRBPCPB), F, T),
    VI_NA_EA_TRBFBPC  = dplyr::if_else(!is.na(EA_TRBFBPC), F, T),
    VI_NA_EA_TRPC     = dplyr::if_else(!is.na(EA_TRPC), F, T),
    VI_NA_EA_TRPCBF   = dplyr::if_else(!is.na(EA_TRPCBF), F, T),
    VI_NA_EA_TRPCBPC  = dplyr::if_else(!is.na(EA_TRPCBPC), F, T),
    VI_NA_EA_VAAGR    = dplyr::if_else(!is.na(EA_VAAGR), F, T),
    VI_NA_EA_VAIND    = dplyr::if_else(!is.na(EA_VAIND), F, T),
    VI_NA_EA_VAADM    = dplyr::if_else(!is.na(EA_VAADM), F, T),
    VI_NA_EA_VASERV   = dplyr::if_else(!is.na(EA_VASERV), F, T),
    VI_NA_EA_PVAAGR   = dplyr::if_else(!is.na(EA_PVAAGR), F, T),
    VI_NA_EA_PVAIND   = dplyr::if_else(!is.na(EA_PVAIND), F, T),
    VI_NA_EA_PVAADM   = dplyr::if_else(!is.na(EA_PVAADM), F, T),
    VI_NA_EA_PVASERV  = dplyr::if_else(!is.na(EA_PVASERV), F, T),
    VI_NA_EA_VATOT    = dplyr::if_else(!is.na(EA_VATOT), F, T),
    VI_NA_EA_IMPLIQ   = dplyr::if_else(!is.na(EA_IMPLIQ), F, T),
    VI_NA_EA_PIB      = dplyr::if_else(!is.na(EA_PIB), F, T),
    VI_NA_EA_PIBPC    = dplyr::if_else(!is.na(EA_PIBPC), F, T),
    VI_NA_EA_VAFAG    = dplyr::if_else(!is.na(EA_VAFAG), F, T),
    VI_NA_EA_VAF      = dplyr::if_else(!is.na(EA_VAF), F, T),
    VI_NA_EA_VAFMI    = dplyr::if_else(!is.na(EA_VAFMI), F, T),
    VI_NA_EA_VAFIT    = dplyr::if_else(!is.na(EA_VAFIT), F, T),
    VI_NA_EA_VAFIC    = dplyr::if_else(!is.na(EA_VAFIC), F, T),
    VI_NA_EA_VAFUP    = dplyr::if_else(!is.na(EA_VAFUP), F, T),
    VI_NA_EA_VAFCV    = dplyr::if_else(!is.na(EA_VAFCV), F, T),
    VI_NA_EA_VAFCA    = dplyr::if_else(!is.na(EA_VAFCA), F, T),
    VI_NA_EA_VAFSE    = dplyr::if_else(!is.na(EA_VAFSE), F, T),
    VI_NA_EA_VAFO     = dplyr::if_else(!is.na(EA_VAFO), F, T),
    VI_NA_EA_PVAFAG   = dplyr::if_else(!is.na(EA_PVAFAG), F, T),
    VI_NA_EA_PVAFMI   = dplyr::if_else(!is.na(EA_PVAFMI), F, T),
    VI_NA_EA_PVAFIT   = dplyr::if_else(!is.na(EA_PVAFIT), F, T),
    VI_NA_EA_PVAFIC   = dplyr::if_else(!is.na(EA_PVAFIC), F, T),
    VI_NA_EA_PVAFUP   = dplyr::if_else(!is.na(EA_PVAFUP), F, T),
    VI_NA_EA_PVAFCV   = dplyr::if_else(!is.na(EA_PVAFCV), F, T),
    VI_NA_EA_PVAFCA   = dplyr::if_else(!is.na(EA_PVAFCA), F, T),
    VI_NA_EA_PVAFSE   = dplyr::if_else(!is.na(EA_PVAFSE), F, T),
    VI_NA_EA_PVAFO    = dplyr::if_else(!is.na(EA_PVAFO), F, T),
    VI_NA_EA_VAFPC    = dplyr::if_else(!is.na(EA_VAFPC), F, T),
    VI_NA_EA_VAFCVPC  = dplyr::if_else(!is.na(EA_VAFCVPC), F, T),
    VI_NA_EA_EMPRSF   = dplyr::if_else(!is.na(EA_EMPRSF), F, T),
    VI_NA_EA_EMPRSFTX = dplyr::if_else(!is.na(EA_EMPRSFTX), F, T),
    VI_NA_EA_RENSF    = dplyr::if_else(!is.na(EA_RENSF), F, T),
    VI_NA_EA_RENPCSF  = dplyr::if_else(!is.na(EA_RENPCSF), F, T),
    VI_NA_EA_EMPRSFAG = dplyr::if_else(!is.na(EA_EMPRSFAG), F, T),
    VI_NA_EA_EMPRSFMI = dplyr::if_else(!is.na(EA_EMPRSFMI), F, T),
    VI_NA_EA_EMPRSFIT = dplyr::if_else(!is.na(EA_EMPRSFIT), F, T),
    VI_NA_EA_EMPRSFUP = dplyr::if_else(!is.na(EA_EMPRSFUP), F, T),
    VI_NA_EA_EMPRSFIC = dplyr::if_else(!is.na(EA_EMPRSFIC), F, T),
    VI_NA_EA_EMPRSFCO = dplyr::if_else(!is.na(EA_EMPRSFCO), F, T),
    VI_NA_EA_EMPRSFSE = dplyr::if_else(!is.na(EA_EMPRSFSE), F, T),
    # Others
...
df_rules_dist_ea_bffam <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_BFFAM_out_munic     = dplyr::if_else(!outlier_function(EA_BFFAM), F, T), # Longitudinal (município)
...
df_rules_dist_ea_trfam <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_TRFAM_out_munic     = dplyr::if_else(!outlier_function(EA_TRFAM), F, T), # Longitudinal (município)
...
df_rules_dist_ea_trpf <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_TRPF_out_munic     = dplyr::if_else(!outlier_function(EA_TRPF), F, T), # Longitudinal (município)
...
df_rules_dist_ea_bpcdef <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_BPCDEF_out_munic     = dplyr::if_else(!outlier_function(EA_BPCDEF), F, T), # Longitudinal (município)
...
df_rules_dist_ea_bpcido <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_BPCIDO_out_munic     = dplyr::if_else(!outlier_function(EA_BPCIDO), F, T), # Longitudinal (município)
...
df_rules_dist_ea_bfbpc <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_BFBPC_out_munic     = dplyr::if_else(!outlier_function(EA_BFBPC), F, T), # Longitudinal (município)
...
df_rules_dist_ea_trbpcdef <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_TRBPCDEF_out_munic     = dplyr::if_else(!outlier_function(EA_TRBPCDEF), F, T), # Longitudinal (município)
...
df_rules_dist_ea_trbpcido <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_TRBPCIDO_out_munic     = dplyr::if_else(!outlier_function(EA_TRBPCIDO), F, T), # Longitudinal (município)
...
df_rules_dist_ea_trbpc <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_TRBPC_out_munic     = dplyr::if_else(!outlier_function(EA_TRBPC), F, T), # Longitudinal (município)
...
df_rules_dist_ea_trbpcpb <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_TRBPCPB_out_munic     = dplyr::if_else(!outlier_function(EA_TRBPCPB), F, T), # Longitudinal (município)
...
df_rules_dist_ea_trbfbpc <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_TRBFBPC_out_munic     = dplyr::if_else(!outlier_function(EA_TRBFBPC), F, T), # Longitudinal (município)
...
df_rules_dist_ea_trpc <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_TRPC_out_munic     = dplyr::if_else(!outlier_function(EA_TRPC), F, T), # Longitudinal (município)
...
df_rules_dist_ea_trpcbf <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_TRPCBF_out_munic     = dplyr::if_else(!outlier_function(EA_TRPCBF), F, T), # Longitudinal (município)
...
df_rules_dist_ea_trpcbpc <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_TRPCBPC_out_munic     = dplyr::if_else(!outlier_function(EA_TRPCBPC), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vaagr <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAAGR_out_munic     = dplyr::if_else(!outlier_function(EA_VAAGR), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vaind <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAIND_out_munic     = dplyr::if_else(!outlier_function(EA_VAIND), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vaadm <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAADM_out_munic     = dplyr::if_else(!outlier_function(EA_VAADM), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vaserv <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VASERV_out_munic     = dplyr::if_else(!outlier_function(EA_VASERV), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvaagr <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVAAGR_out_munic     = dplyr::if_else(!outlier_function(EA_PVAAGR), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvaind <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVAIND_out_munic     = dplyr::if_else(!outlier_function(EA_PVAIND), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvaadm <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVAADM_out_munic     = dplyr::if_else(!outlier_function(EA_PVAADM), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvaserv <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVASERV_out_munic     = dplyr::if_else(!outlier_function(EA_PVASERV), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vatot <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VATOT_out_munic     = dplyr::if_else(!outlier_function(EA_VATOT), F, T), # Longitudinal (município)
...
df_rules_dist_ea_impliq <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_IMPLIQ_out_munic     = dplyr::if_else(!outlier_function(EA_IMPLIQ), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pib <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PIB_out_munic     = dplyr::if_else(!outlier_function(EA_PIB), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pibpc <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PIBPC_out_munic     = dplyr::if_else(!outlier_function(EA_PIBPC), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vaf <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAF_out_munic     = dplyr::if_else(!outlier_function(EA_VAF), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vafag <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAFAG_out_munic     = dplyr::if_else(!outlier_function(EA_VAFAG), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vafmi <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAFMI_out_munic     = dplyr::if_else(!outlier_function(EA_VAFMI), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vafit <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAFIT_out_munic     = dplyr::if_else(!outlier_function(EA_VAFIT), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vafic <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAFIC_out_munic     = dplyr::if_else(!outlier_function(EA_VAFIC), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vafup <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAFUP_out_munic     = dplyr::if_else(!outlier_function(EA_VAFUP), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vafcv <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAFCV_out_munic     = dplyr::if_else(!outlier_function(EA_VAFCV), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vafca <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAFCA_out_munic     = dplyr::if_else(!outlier_function(EA_VAFCA), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vafse <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAFSE_out_munic     = dplyr::if_else(!outlier_function(EA_VAFSE), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vafo <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAFO_out_munic     = dplyr::if_else(!outlier_function(EA_VAFO), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvafag <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVAFAG_out_munic     = dplyr::if_else(!outlier_function(EA_PVAFAG), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvafmi <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVAFMI_out_munic     = dplyr::if_else(!outlier_function(EA_PVAFMI), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvafit <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVAFIT_out_munic     = dplyr::if_else(!outlier_function(EA_PVAFIT), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvafic <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVAFIC_out_munic     = dplyr::if_else(!outlier_function(EA_PVAFIC), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvafup <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVAFUP_out_munic     = dplyr::if_else(!outlier_function(EA_PVAFUP), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvafcv <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVAFCV_out_munic     = dplyr::if_else(!outlier_function(EA_PVAFCV), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvafca <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVAFCA_out_munic     = dplyr::if_else(!outlier_function(EA_PVAFCA), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvafse <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVAFSE_out_munic     = dplyr::if_else(!outlier_function(EA_PVAFSE), F, T), # Longitudinal (município)
...
df_rules_dist_ea_pvafo <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_PVAFO_out_munic     = dplyr::if_else(!outlier_function(EA_PVAFO), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vafpc <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAFPC_out_munic     = dplyr::if_else(!outlier_function(EA_VAFPC), F, T), # Longitudinal (município)
...
df_rules_dist_ea_vafcvpc <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_VAFCVPC_out_munic     = dplyr::if_else(!outlier_function(EA_VAFCVPC), F, T), # Longitudinal (município)
...
df_rules_dist_ea_emprsf <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_EMPRSF_out_munic     = dplyr::if_else(!outlier_function(EA_EMPRSF), F, T), # Longitudinal (município)
...
df_rules_dist_ea_emprsftx <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_EMPRSFTX_out_munic     = dplyr::if_else(!outlier_function(EA_EMPRSFTX), F, T), # Longitudinal (município)
...
df_rules_dist_ea_rensf <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_RENSF_out_munic     = dplyr::if_else(!outlier_function(EA_RENSF), F, T), # Longitudinal (município)
...
df_rules_dist_ea_renpcsf <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_RENPCSF_out_munic     = dplyr::if_else(!outlier_function(EA_RENPCSF), F, T), # Longitudinal (município)
...
df_rules_dist_ea_emprsfag <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_EMPRSFAG_out_munic     = dplyr::if_else(!outlier_function(EA_EMPRSFAG), F, T), # Longitudinal (município)
...
df_rules_dist_ea_emprsfmi <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_EMPRSFMI_out_munic     = dplyr::if_else(!outlier_function(EA_EMPRSFMI), F, T), # Longitudinal (município)
...
df_rules_dist_ea_emprsfit <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_EMPRSFIT_out_munic     = dplyr::if_else(!outlier_function(EA_EMPRSFIT), F, T), # Longitudinal (município)
...
df_rules_dist_ea_emprsfup <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_EMPRSFUP_out_munic     = dplyr::if_else(!outlier_function(EA_EMPRSFUP), F, T), # Longitudinal (município)
...
df_rules_dist_ea_emprsfic <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_EMPRSFIC_out_munic     = dplyr::if_else(!outlier_function(EA_EMPRSFIC), F, T), # Longitudinal (município)
...
df_rules_dist_ea_emprsfco <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_EMPRSFCO_out_munic     = dplyr::if_else(!outlier_function(EA_EMPRSFCO), F, T), # Longitudinal (município)
...
df_rules_dist_ea_emprsfse <- data |> 
  ...
  dplyr::mutate(
    ...
    DF_EA_EMPRSFSE_out_munic     = dplyr::if_else(!outlier_function(EA_EMPRSFSE), F, T), # Longitudinal (município)
