...
rules_dist_prop_ma_agro <- validate::validator(
  ...
  DF_MA_AGRO_out_datamaid_year = validate::do_by(MA_AGRO, by = ANO, fun = outlier_function) == F, # Transversal (ano)
  
  DF_MA_AGRO_out_datamaid_city = validate::do_by(MA_AGRO, by = IBGE7, fun = outlier_function) == F, # Longitudinal (município)
...
rules_dist_ratio_ma_bovino <- validate::validator(
  ...
  DF_MA_BOVINO_out_datamaid_year = validate::do_by(MA_BOVINO, by = ANO, fun = outlier_function) == F, # Transversal (ano)
  
  DF_MA_BOVINO_out_datamaid_city = validate::do_by(MA_BOVINO, by = IBGE7, fun = outlier_function) == F, # Longitudinal (município)
...
rules_dist_prop_ma_cana <- validate::validator(
  ...
  DF_MA_CANA_out_datamaid_year = validate::do_by(MA_CANA, by = ANO, fun = outlier_function) == F, # Transversal (ano)
  
  DF_MA_CANA_out_datamaid_city = validate::do_by(MA_CANA, by = IBGE7, fun = outlier_function) == F, # Longitudinal (município)
...
rules_dist_out_ma_cfem <- validate::validator(
  ...
  DF_MA_CFEMA_out_datamaid_year = validate::do_by(MA_CFEM, by = ANO, fun = outlier_function) == F, # Transversal (ano)
  
  DF_MA_CFEMA_out_datamaid_city = validate::do_by(MA_CFEM, by = IBGE7, fun = outlier_function) == F # Longitudinal (município)
...
rules_dist_out_ma_crh <- validate::validator(
  ...
  DF_MA_CRH_out_datamaid_year = validate::do_by(MA_CRH, by = ANO, fun = outlier_function) == F, # Transversal (ano)
  
  DF_MA_CRH_out_datamaid_city = validate::do_by(MA_CRH, by = IBGE7, fun = outlier_function) == F # Longitudinal (município)
...
rules_dist_prop_ma_flonativa <- validate::validator(
  ...
  DF_MA_FLONATIVA_out_datamaid_year = validate::do_by(MA_FLONATIVA, by = ANO, fun = outlier_function) == F, # Transversal (ano)
  
  DF_MA_FLONATIVA_out_datamaid_city = validate::do_by(MA_FLONATIVA, by = IBGE7, fun = outlier_function) == F, # Longitudinal (município)
...
rules_dist_prop_ma_focos <- validate::validator(
  ...
  DF_MA_FOCOS_out_datamaid_year = validate::do_by(MA_FOCOS, by = ANO, fun = outlier_function) == F, # Transversal (ano)
  
  DF_MA_FOCOS_out_datamaid_city = validate::do_by(MA_FOCOS, by = IBGE7, fun = outlier_function) == F, # Longitudinal (município)
...
rules_dist_ratio_ma_frota <- validate::validator(
  ...
  DF_MA_FROTA_out_datamaid_year = validate::do_by(MA_FROTA, by = ANO, fun = outlier_function) == F, # Transversal (ano)
  
  DF_MA_FROTA_out_datamaid_city = validate::do_by(MA_FROTA, by = IBGE7, fun = outlier_function) == F, # Longitudinal (município)
...
rules_dist_total_ma_icmsecolog <- validate::validator(
  ...
  DF_MA_ICMSECOLOG_out_datamaid_year = validate::do_by(MA_ICMSECOLOG, by = ANO, fun = outlier_function) == F, # Transversal (ano)
  
  DF_MA_ICMSECOLOG_out_datamaid_city = validate::do_by(MA_ICMSECOLOG, by = IBGE7, fun = outlier_function) == F # Longitudinal (município)
)
```
...
rules_dist_prop_ma_infra <- validate::validator(
  ...
  DF_MA_INFRA_out_datamaid_year = validate::do_by(MA_INFRA, by = ANO, fun = outlier_function) == F, # Transversal (ano)
  
  DF_MA_INFRA_out_datamaid_city = validate::do_by(MA_INFRA, by = IBGE7, fun = outlier_function) == F, # Longitudinal (município)
...
rules_dist_prop_ma_reflo <- validate::validator(
  ...
  DF_MA_REFLO_out_datamaid_year = validate::do_by(MA_REFLO, by = ANO, fun = outlier_function) == F, # Transversal (ano)
  
  DF_MA_REFLO_out_datamaid_city = validate::do_by(MA_REFLO, by = IBGE7, fun = outlier_function) == F, # Longitudinal (município)
