...
ano_base_alter <- c(
  ...
  "AS_IDCRASME"              = 2012,
   ...
   "AS_POPCADUNICO"          = 2012,     
   "AS_COBBF"                = 2012,              
   "AS_POPIDCADSPOP"         = 2012,      
   "AS_POPRURALPOP"          = 2012,         
   "AS_POPPOBEXTRPOB"        = 2012,  
   "AS_PCOBBFMEIOSAL"        = 2012,      
   "AS_POPPOBEXTRCAD"        = 2012,      
   "AS_POPIDPOBEXTRCAD"      = 2012,      
   "AS_IDOSOPOBEXTRPOBCADS"  = 2012,  
   "AS_DEFPOBEXTRCAD"        = 2012,        
   "AS_CRIANADOLEPOBEXTRPOP" = 2012, 
   "AS_POPIDPOBEXTRCADS"     = 2012,     
   "AS_POPIDCADS"            = 2012,        
   "AS_EFINCOMPCAD"          = 2012,         
   "AS_PENLECAD"             = 2012,          
   "AS_POPINDIGENACADS"      = 2012,      
   "AS_POPPRETAPARDACADS"    = 2012,    
   "AS_PVULSANEACAD"         = 2012,      
   "AS_SANEACAD"             = 2012,           
   "AS_POPRURALCADS"         = 2012,        
   "AS_IGDMCONDE"            = 2012,       
   "AS_IGDMCONDS"            = 2012,       
   "AS_IGDMATU"              = 2012,        
   "AS_IGDMCOBCAD"           = 2012,        
...
df_rules_dist_as_fcadmeiosal <- data |> 
  dplyr::filter( # Filtro condicional para variáveis que estão em "ano_base_alter"
    dplyr::case_when(
      "AS_FCADMEDIOSAL" %in% names(ano_base_alter) ~ ANO >= ano_base_alter["AS_FCADMEIOSAL"],
      TRUE ~ ANO >= min(ANO, na.rm = T)
    )
  ) |>
