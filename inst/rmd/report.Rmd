...
exemplo: mediana_movel_SE_MEDICOS, outlier_SE_MEDICOS, etc.
...
-   **minimo**:  o valor mais recente é maior ou igual ao menor valor da série histórica;

-   **maximo**: o valor mais recente é menor ou igual ao maior valor da série histórica;

-   **mediana_movel**: o valor atual é menor ou igual a mediana móvel.
