...
fun_tes <- function(x){ return(min(x, na.rm = T))}
##### PROPORCAO
distributionrules_magro <- validate::validator(
  ...
  DF_M_AGRO_min_year = M_AGRO  >= konst*validate::do_by(M_AGRO, by = ANO, fun = fun_tes),
  DF_M_AGRO_min_city = M_AGRO  >= konst*validate::do_by(M_AGRO, by = IBGE7, fun = fun_tes),
