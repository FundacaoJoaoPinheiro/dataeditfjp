...
df_rules_valid_eo_all <- data |> 
  ...
  dplyr::mutate(
    ...
    VI_NA_EO_ADEDG1EJAF      = dplyr::if_else(!is.na(EO_ADEDG1EJAF), F, NA),
    VI_NA_EO_ADEDG2EJAF      = dplyr::if_else(!is.na(EO_ADEDG2EJAF), F, NA),
    VI_NA_EO_ADEDG3EJAF      = dplyr::if_else(!is.na(EO_ADEDG3EJAF), F, NA),
    VI_NA_EO_ADEDG4EJAF      = dplyr::if_else(!is.na(EO_ADEDG4EJAF), F, NA),
    VI_NA_EO_ADEDG5EJAF      = dplyr::if_else(!is.na(EO_ADEDG5EJAF), F, NA),
...
df_sumario_valid_eo <- df_rules_valid_eo_all |> 
  dplyr::select(
    Ano, 
    ibge7, 
    dplyr::starts_with(c("VI_", "VI_NA_"))
  ) |> 
