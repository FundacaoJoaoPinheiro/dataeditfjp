...
exclusions_years <- c(
  ...
  "EO_PALUNOSM8"       = c(2004,2005,2015,2017,2020),
  "EO_PALUNOSP8"       = c(2004,2005,2015,2017,2020),
  "EO_PALUNOSM11"      = c(2004,2005,2010,2020),
  "EO_PALUNOSP11"      = c(2004,2005,2010,2020),
  "EO_TXAPROV1A5"      = c(2006,2008,2020),
...
## df com o resultado das aplicações das regras
df_rules_dist_EO_IQEM4 <- data |> remove_year_variable(variable = "EO_IQEM4", exclusions_years = exclusions_years) |>
  dplyr::filter( # Filtro condicional para variáveis que estão em "ano_base_alter"
    dplyr::case_when(
