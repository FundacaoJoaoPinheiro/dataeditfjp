...
CF_TVL_EE_QUANT_A = do_by(EE_QUANT, by = ANO, fun = hampel_filter) == F, # Transversal (ano)
  ...
  CF_LGT_EE_QUANT_B = EE_QUANT <= (2 * do_by(EE_QUANT, by = IBGE7, fun = rollmean, k = 3, fill = NA, align = "right")), # Longitudinal (município)
  ...
  CF_LGT_EE_PROGE_B = EE_PROGE <= (2 * do_by(EE_PROGE, by = IBGE7, fun = rollmean, k = 3, fill = NA, align = "right")), # Longitudinal (município)
  ...
  CF_LGT_EE_ESPESC_B = EE_ESPESC <= (2 * do_by(EE_ESPESC, by = IBGE7, fun = rollmean, k = 3, fill = NA, align = "right")), # Longitudinal (município)
  ...
  CF_LGT_EE_ILRHE_B = EE_ILRHE <= (2 * do_by(EE_ILRHE, by = IBGE7, fun = rollmean, k = 3, fill = NA, align = "right")) # Longitudinal (município)
)
```
