...
exclusions_years <- c(
  "SP_PC1"         = c(2009,2010,2012),
  "SP_PMPC"        = c(2012),
  "SP_JUI2"        = c(2015,2016,2017,2018,2019,2021),
  "SP_PRO2"        = c(2011,2012,2013,2014,2015,2016,2017,2018,2019,2021),
  "SP_DEFP2"       = c(2018),
  "SP_PRESOSPC"    = c(2015,2016,2017,2018,2019),
  "SP_OCUPPC"      = c(2015,2016,2017,2018,2019),
  "SP_PRESOSSUAPI" = c(2008,2018),
  "SP_OCUPSUAPI"   = c(2008,2018)
)
...
<!--   remove_year_variable(variable = "SP_OCUPSUAPI", exclusions_years = exclusions_years) |> -->
